...
@section('content')
	...
	<div class="inner-body">
		...
		<div id="company-stats">
			<div id="stats">
				@if (count($reviews) == 0)
					<p><span class="glyphicon glyphicon-thumbs-up" id="title-recommend-icon"></span></span><span id="title-recommend">--% Recommend</span></p>
					<hr style="width: 20%"/>
					<p><span class="glyphicon glyphicon-time title-icon"></span><span class="title-text">--% say Fair Hours</span></p>
					<p><span class="glyphicon glyphicon-usd title-icon"></span></span><span class="title-text">--% say Good Pay</span></p>
					<p><span class="glyphicon glyphicon-briefcase title-icon"></span></span><span class="title-text">--% say Future Work</span></p>
					<hr style="width: 20%"/>
				@else
